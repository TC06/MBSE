/**
 */
package mypetrinet.petrinet.provider;
...
/**
 * This is the item provider adapter for a {@link dk.dtu.compute.mbse.petrinet.Petrinet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PetrinetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetrinetPackage.Literals.PETRINET__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PetrinetPackage.Literals.PETRINET__NODES);
			childrenFeatures.add(PetrinetPackage.Literals.PETRINET__ARCS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PetrinetPackage.Literals.PETRINET__NODES,
		...
		newChildDescriptors.add
			(createChildParameter
				(PetrinetPackage.Literals.PETRINET__ARCS,
	...
	public ResourceLocator getResourceLocator() {
		return MypetrinetEditPlugin.INSTANCE;
	}
