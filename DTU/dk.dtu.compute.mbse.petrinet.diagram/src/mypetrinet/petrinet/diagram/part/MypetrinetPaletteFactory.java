 ...
 * @generated
 */
public class MypetrinetPaletteFactory {
	...
	*/
	private ToolEntry createArc1CreationTool() {
		DefaultLinkToolEntry entry = new DefaultLinkToolEntry(Messages.Arc1CreationTool_title,
				Messages.Arc1CreationTool_desc, Collections.singletonList(MypetrinetElementTypes.Arc_4001));
		entry.setId("createArc1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(MypetrinetElementTypes.getImageDescriptor(MypetrinetElementTypes.Arc_4001));
	...
	*/
	private ToolEntry createTransition2CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Transition2CreationTool_title,
				...
				Collections.singletonList(MypetrinetElementTypes.Transition_2002));
		entry.setId("createTransition2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(MypetrinetElementTypes.getImageDescriptor(MypetrinetElementTypes.Transition_2002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createPlace3CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Place3CreationTool_title,
				Messages.Place3CreationTool_desc, Collections.singletonList(MypetrinetElementTypes.Place_2001));
		entry.setId("createPlace3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(MypetrinetElementTypes.getImageDescriptor(MypetrinetElementTypes.Place_2001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	*/
	private ToolEntry createToken4CreationTool() {
		DefaultNodeToolEntry entry = new DefaultNodeToolEntry(Messages.Token4CreationTool_title,
				Messages.Token4CreationTool_desc, Collections.singletonList(MypetrinetElementTypes.Token_3001));
		entry.setId("createToken4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(MypetrinetElementTypes.getImageDescriptor(MypetrinetElementTypes.Token_3001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
