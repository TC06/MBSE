...
import mypetrinet.petrinet.diagram.edit.commands.ArcCreateCommand;
import mypetrinet.petrinet.diagram.edit.commands.ArcReorientCommand;
import mypetrinet.petrinet.diagram.edit.commands.TokenCreateCommand;
 ...
 * @generated
 */
public class PlaceItemSemanticEditPolicy extends MypetrinetBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public PlaceItemSemanticEditPolicy() {
		super(MypetrinetElementTypes.Place_2001);
	}
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		if (MypetrinetElementTypes.Token_3001 == req.getElementType()) {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MypetrinetVisualIDRegistry.getVisualID(incomingLink) == ArcEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MypetrinetVisualIDRegistry.getVisualID(outgoingLink) == ArcEditPart.VISUAL_ID) {
	...
	*/
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (MypetrinetVisualIDRegistry.getVisualID(node)) {
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (MypetrinetElementTypes.Arc_4001 == req.getElementType()) {
