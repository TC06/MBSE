 ...
 * @generated
 */
public class PlaceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MypetrinetParserProvider.getParser(MypetrinetElementTypes.Place_2001, getParserElement(),
					MypetrinetVisualIDRegistry
							.getType(mypetrinet.petrinet.diagram.edit.parts.PlaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
