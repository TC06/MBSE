...
import mypetrinet.petrinet.diagram.edit.policies.TransitionItemSemanticEditPolicy;
...
public class TransitionEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TransitionNameEditPart) {
			((TransitionNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTransitionNameFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MypetrinetVisualIDRegistry.getType(TransitionNameEditPart.VISUAL_ID));
	}
