...
import mypetrinet.petrinet.diagram.edit.policies.PlaceCanonicalEditPolicy;
import mypetrinet.petrinet.diagram.edit.policies.PlaceItemSemanticEditPolicy;
...
public class PlaceEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(MypetrinetVisualIDRegistry.TYPED_INSTANCE));
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MypetrinetVisualIDRegistry.getType(PlaceNameEditPart.VISUAL_ID));
	}
