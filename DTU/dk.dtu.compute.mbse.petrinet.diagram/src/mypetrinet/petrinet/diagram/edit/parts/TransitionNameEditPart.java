package mypetrinet.petrinet.diagram.edit.parts;
...
import mypetrinet.petrinet.diagram.edit.policies.MypetrinetTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TransitionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new MypetrinetTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MypetrinetParserProvider.getParser(MypetrinetElementTypes.Transition_2002, getParserElement(),
					MypetrinetVisualIDRegistry
							.getType(mypetrinet.petrinet.diagram.edit.parts.TransitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, MypetrinetEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
