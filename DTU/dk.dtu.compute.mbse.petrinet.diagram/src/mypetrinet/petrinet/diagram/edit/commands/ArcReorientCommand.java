...
public class ArcReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return MypetrinetBaseItemSemanticEditPolicy.getLinkConstraints().canExistArc_4001(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		Petrinet container = (Petrinet) getLink().eContainer();
		return MypetrinetBaseItemSemanticEditPolicy.getLinkConstraints().canExistArc_4001(container, getLink(), source,
				getNewTarget());
	}
