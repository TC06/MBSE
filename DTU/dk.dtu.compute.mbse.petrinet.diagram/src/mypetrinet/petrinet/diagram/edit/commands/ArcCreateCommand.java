package mypetrinet.petrinet.diagram.edit.commands;
...
public class ArcCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	private final Petrinet container;
	...
	*/
	public boolean canExecute() {
		...
		return MypetrinetBaseItemSemanticEditPolicy.getLinkConstraints().canCreateArc_4001(getContainer(), getSource(),
				getTarget());
	}
	...
	* @generated
	*/
	protected void doConfigure(Arc newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
	...
	* @generated
	*/
	private static Petrinet deduceContainer(EObject source, EObject target) {
		// Find container element for the new link.
		// Climb up by containment hierarchy starting from the source
		// and return the first element that is instance of the container class.
		for (EObject element = source; element != null; element = element.eContainer()) {
			if (element instanceof Petrinet) {
				return (Petrinet) element;
			}
		}
		return null;
	}
