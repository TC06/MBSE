...
import mypetrinet.petrinet.diagram.parsers.MessageFormatParser;
import mypetrinet.petrinet.diagram.part.MypetrinetVisualIDRegistry;

/**
 * @generated
 */
public class MypetrinetParserProvider extends AbstractProvider implements IParserProvider {
	...
	*/
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(MypetrinetVisualIDRegistry.getVisualID(vid));
		}
		View view = (View) hint.getAdapter(View.class);
		if (view != null) {
			return getParser(MypetrinetVisualIDRegistry.getVisualID(view));
		}
		return null;
	}
	...
	*/
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			if (MypetrinetElementTypes.getElement(hint) == null) {
				return false;
			}
